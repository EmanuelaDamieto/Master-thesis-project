...
#deg long 1191, deg short 3536, not deg long 12557, not deg short 16924

contingency_table <- matrix(c(1191,3536,12557,16924), nrow=2, ncol = 2, dimnames = list(c("genes with long introns", "genes with short introns"), c("DEG", "not DEG")))
