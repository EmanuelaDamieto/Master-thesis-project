...
INPUTFILE=$(realpath /mnt/picea/storage/reference/Picea-abies/v2.0/fasta/all_merged_no_overlaps_no_dup_features_gt_gff_after_merge_ensembl_renamed_over_30aa_salmon_redundant_mRNA_removed.gff3.mRNA.fa.gz)
#The third argument is an output directory for the indices 
OUTDIR=$(realpath /mnt/picea/storage/reference/Picea-abies/v2.0/indices/salmon)
